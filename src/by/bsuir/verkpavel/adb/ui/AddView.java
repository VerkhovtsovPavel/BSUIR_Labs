...
public class AddView extends JFrame {
     ...
     */
    private AddView() throws ParseException {
    ...
    private void configureDefaultLayot() throws ParseException {
        ...
        saveBtn.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                // TODO Maybe refactor
                String realCity = realCityComboBox.getItemAt(realCityComboBox.getSelectedIndex());
                ...
                String familyStatus = (String) familyStatusComboBox.getSelectedItem();
                ...
                if (checkRequiredFields(firstName, lastName, middleName, bornDate, passportSeries,
                    ...
                    JOptionPane.showMessageDialog(null, "Не все обязательные поля заполнены!", "Error",
        ...
        manRadioButton.setBounds(27, 61, 92, 23);
        mainPanel.add(manRadioButton);

        womanRadioButton = new JRadioButton("\u0416\u0435\u043D\u0441\u043A\u0438\u0439");
        womanRadioButton.setBounds(27, 86, 109, 23);
        mainPanel.add(womanRadioButton);

        bornDateField = new JFormattedTextField(new SimpleDateFormat("dd/MM/yyyy"));
        ...
        passportTakeDateField = new JFormattedTextField(new SimpleDateFormat("dd/MM/yyyy"));
        ...
        passportSeriesField = new JTextField();
        passportSeriesField.setColumns(10);
        passportSeriesField.setBounds(109, 259, 35, 23);
        mainPanel.add(passportSeriesField);

        MaskFormatter passportSeriesMask = new MaskFormatter("#######");
        passportNumberField = new JFormattedTextField(passportSeriesMask);
