...
//    	BaseDistribution distribution = new UniformDistribution(10,20,10000000);
//    	BaseDistribution distribution = new GaussDistribution(10, 20, 15, (float) 2.85, 10000);
//    	BaseDistribution distribution = new ExponensialDistribution(10, 20, 23, 100000);
    	BaseDistribution distribution = new GammaDistribution(10, 3, 10000);
    	distribution.build();
