...
\section{Технико-экономическое обоснование разработки и использования ПС определения психологические характеристик личности по образцам почерка}
...
Экономические расходы на оплату труда составят $ \text{Р}_{\text{от}}=\num{\totalAnalyticExpense} {\text{\byr}} $, что для пользователя будет выступать в качестве экономического эффекта.
