...
INSERT INTO `deliveryService`.`Position` (`idPosition`, `description`) VALUES  (6, 'Кассир-приемщик');

INSERT INTO `deliveryService`.`Position` (`idPosition`, `description`) VALUES  (7, 'Водитель');

INSERT INTO `deliveryService`.`Position` (`idPosition`, `description`) VALUES  (8, 'Логист');

INSERT INTO `deliveryService`.`Position` (`idPosition`, `description`) VALUES  (9, 'Глава отдела доставки');

INSERT INTO `deliveryService`.`Position` (`idPosition`, `description`) VALUES  (10, 'Директор');
