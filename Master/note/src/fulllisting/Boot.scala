...
import by.pavelverk.hardwrite.core.action.{JdbcActionStorage, ActionService}
...
object Boot extends App {
  ...
  def startApplication() = {
    ...
    val actionStorage = new JdbcActionStorage(databaseConnector)	
    ...
    val actionService = new actionService(actionreStorage)
    val httpRoute = new HttpRoute(usersService, sampleService, featuresService, authService, actionService, config.secretKey)
