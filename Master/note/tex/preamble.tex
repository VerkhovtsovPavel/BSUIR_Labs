...
\makeatletter
\newcommand\sectionrighted{%
  \clearpage\@startsection {section}{1}%
    {\z@}%
    {-1em \@plus -1ex \@minus -.2ex}%
    {1em \@plus .2ex}%
    {\raggedleft\hyphenpenalty=10000\normalfont\large\bfseries\MakeUppercase}%
  }
\makeatother
...
\captionsetup[figure]{skip=20pt,labelformat=stbfigure,justification=centering,font=small,labelfont=bf,textfont=bf}
...
% Зачем: Использование комментариев в тексте
...
% Зачем: Запрет переноса в последней строке обзаца
