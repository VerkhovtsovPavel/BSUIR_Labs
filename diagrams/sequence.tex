...
\draw [dotted] 
  (t0 left) -- (t0 right) node[right] {}
  (t1 left) -- (t1 right) node[right] {}
  (t2 left) -- (t2 right) node[right] {}
  (t3 left) -- (t3 right) node[right] {}
  (t4 left) -- (t4 right) node[right] {}
  (t5 left) -- (t5 right) node[right] {}
  (t6 left) -- (t6 right) node[right] {}
  (t7 left) -- (t7 right) node[right] {};
